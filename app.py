...
# 1. 直接从“中央厨房”和“配置库”端菜
try:
    from core_engine import get_global_data, get_stock_metadata, calculate_macro_scores, calculate_molt_scores
    from my_stock_pool import TIC_MAP, REGIME_MAP
except ImportError:
    st.error("⚠️ 核心计算引擎 (core_engine.py) 或 股票池 (my_stock_pool.py) 丢失！")
    st.stop()
