...
**一处待观察**：短链的首末名都走行业回退时，代表票一变名字就不同，选择框会出现「Steel 36%｜SHW/SNAP/PPG → Steel 36%｜TXN/SNAP/NUE」这种又长又没信息的标签。方案里定的规则就是「首末名不同就都显示」，先照做，之后要不要给回退名加个「行业相同就只显示一次」的例外，等主理人定。
